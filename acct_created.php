...
<div class="top_bg" id="home">
	<div class="container">
		<div class="header_top">
			...
			<div class="top_left">
				<span class="top_right"> <a class="header_top" style ="color:white;" href="feedback.php">Feedback .</style></a> | Call us : +91 9899357858</span>
			</div>
...
<div class="header_bg">
   <div class="container">
	<div class="header">
	  <div class="head-t">
		 <div class="logo">
			  <a href="index.php"><h1>My<span>Shop</span></h1> </a>
		  </div>
